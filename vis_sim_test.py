...
if __name__ == "__main__":
    ...
    Show_Simulation_Sample = True      # show sample of simulation capabilities
    Show_Critical_Angle_Sample = True   # show sample of critical angle calculations
    Critical_Display_Outputs = True    # toggle display of all angles during calculation with pauses and outputs

    ##########################################################################
    ########################### Simulator Animations #########################
    ##########################################################################
    if Show_Simulation_Sample:
