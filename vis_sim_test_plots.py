...
if __name__ == "__main__":
    ...
    _pi = sim.p_i
    _a1 = angs_r.reshape(-1, 1)   # axis 1 limits
    _a2 = angs_p.reshape(-1, 1)   # axis 2 limits
    _a3 = angs_y.reshape(-1, 1)   # axis 3 limits
    _a4 = angs_rg.reshape(-1, 1)  # axis 4 limits
    _a5 = angs_pg.reshape(-1, 1)  # axis 5 limits
    _a6 = angs_yg.reshape(-1, 1)  # axis 6 limits
